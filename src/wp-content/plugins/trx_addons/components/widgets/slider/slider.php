...
class trx_addons_widget_slider extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ($engine == 'swiper') {
			...
			$large = isset($instance['large']) && (int)$instance['large'] > 0 ? "on" : "off";
			$controls = isset($instance['controls']) && (int)$instance['controls'] > 0 ? "on" : "off";
			$label_prev = isset($instance['label_prev']) ? $instance['label_prev'] : '';
			$label_next = isset($instance['label_next']) ? $instance['label_next'] : '';
			$pagination = isset($instance['pagination']) && (int)$instance['pagination'] > 0 ? "on" : "off";
