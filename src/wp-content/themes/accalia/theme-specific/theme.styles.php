...
.wpgdprc-checkbox label:before, .woocommerce .checkout p.wpgdprc-checkbox label:before, 
...
.widget_block .wp-block-group .select_container select,
.widget_block .wp-block-group .select_container:before {
